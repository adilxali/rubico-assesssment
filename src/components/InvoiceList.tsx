...
export default function InvoiceList({ onCreateNew }: InvoiceListProps) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "sent":
        return "bg-[#274268]/10 text-[#274268]";
      case "overdue":
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {filteredAndSortedInvoices.length} total invoices
          </p>
        </div>
        <button
          onClick={onCreateNew}
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="mb-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              <select
                className="mt-2 border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-[#274268] focus:border-transparent"
